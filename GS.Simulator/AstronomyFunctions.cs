...
// Astronomy Functions
//
// Description:	Astronomy functions class that wraps up the NOVAS functions in a
...
namespace GS.Simulator
{
    public static class AstronomyFunctions
    {
        ...
        {
            double days_since_j_2000 = AstroUtilities.JulianDateUtc - 2451545.0;
        ...
        /// <summary>
        /// Calcualte RA/Dec vector from AltAz vector - Return RA and Dec in degrees
        /// </summary>
