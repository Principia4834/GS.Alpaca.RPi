    ...
    public static class TelescopeHardware
    {
        ...
        public static double DeclinationRate
        {
            ...
            set
            {
                ...
                if (!(TrackingRate == DriveRate.Sidereal)) // We are not tracking at sidereal rate
                    throw new ASCOM.InvalidOperationException($"DeclinationRate can only be set when tracking at sidereal rate. The current tracking rate is: {TrackingRate}.");
        ...
        public static double RightAscensionRate
        {
            ...
            set
            {
                ...
                if (!(TrackingRate == DriveRate.Sidereal)) // We are not tracking at sidereal rate
                    throw new ASCOM.InvalidOperationException($"RightAscensionRate can only be set when tracking at sidereal rate. The current tracking rate is: {TrackingRate}.");
